...
def evaluate(predictions, pred_probabilities, test_target):
    ...
    precision, recall, _ = precision_recall_curve(test_target, pred_probabilities, pos_label=18)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", default="KNN_task1.model", type=str, help="Model path")
    parser.add_argument("--pca_path", default="pca_KNNtask1", type=str, help="PCA path")
